...
public class BankCard extends EditText{
    public BankCard(Context context) {
        super(context);
    }

    public BankCard(Context context, AttributeSet attrs) {
        super(context, attrs);
        addTextChangedListener(watcher);
    }

    public BankCard(Context context, AttributeSet attrs, int defStyleAttr) {
