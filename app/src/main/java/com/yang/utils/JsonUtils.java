...
public class JsonUtils {
	...
	public static <T> T fromJson(String json, Type tyoft) {
		return fromJson(json, tyoft, null);
	}
	...
	public static <T> T fromJson(String json, Class<T> cls, String datePattern) {
		...
		try {
			...
			LogUtils.e("异常fromJson="+e.getMessage().toString());
			e.printStackTrace();
			return null;
		}
	}
	...
	public static Object transferBean(RespBean st, Class cla){
		Gson gson = new Gson();
		return gson.fromJson(gson.toJson(st.getResp()),cla);
	}
}