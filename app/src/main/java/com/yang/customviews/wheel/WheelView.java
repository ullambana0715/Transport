...
package com.yang.customviews.wheel;
...
//	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0xeaffffff, 0x33ffffff };
	...
	/**
	 * Sets view adapter. Usually newmsg adapters contain different views, so it
	...
	private void initResourcesIfNecessary() {
		...
		setBackgroundResource(R.drawable.wheel_img_bg);
	}
