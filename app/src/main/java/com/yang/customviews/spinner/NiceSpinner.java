package com.yang.customviews.spinner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.yang.R.styleable.NiceSpinner);
        int defaultPadding = resources.getDimensionPixelSize(com.yang.R.dimen.one_and_a_half_grid_unit);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
        setPadding(resources.getDimensionPixelSize(com.yang.R.dimen.three_grid_unit), defaultPadding, defaultPadding,
            defaultPadding);
        setClickable(true);

        backgroundSelector = typedArray.getResourceId(com.yang.R.styleable.NiceSpinner_backgroundSelector, com.yang.R.drawable.selector);
        setBackgroundResource(backgroundSelector);
        textColor = typedArray.getColor(com.yang.R.styleable.NiceSpinner_textTint, Color.GRAY);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, com.yang.R.drawable.spinner_drawable));
        } else {
            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, com.yang.R.drawable.drop_down_shadow));
        }
        ...
        isArrowHide = typedArray.getBoolean(com.yang.R.styleable.NiceSpinner_hideArrow, false);
        if (!isArrowHide) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, com.yang.R.drawable.arrow);
            int resId = typedArray.getColor(com.yang.R.styleable.NiceSpinner_arrowTint, -1);
