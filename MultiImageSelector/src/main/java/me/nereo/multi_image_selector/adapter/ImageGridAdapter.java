...
import me.nereo.multi_image_selector.SpaceImageDetailActivity;
import me.nereo.multi_image_selector.bean.Image;

/**
 * 图片Adapter
 * Created by cc on 2015/4/7.
 * Updated by cc on 2016/1/19.
 */
...
//            if (w == 0 && h == 0) {
//                Toast.makeText(mContext, "图片质量过低", Toast.LENGTH_LONG).show();
//            } else if (w < 640 && h < 640) {
//                Toast.makeText(mContext, "图片质量过低", Toast.LENGTH_LONG).show();
//            } else {
...
//                intent.putExtra("images",getItem(i).path);//非必须
...
//
//                intent.putExtra("width", holder.image.getWidth());//必须
//                intent.putExtra("height", holder.image.getHeight());//必须
        ...
        void bindData(final Image data) {
            ...
            if (showSelectIndicator) {
                ...
                if (mSelectedImages.contains(data)) {
                    // 设置选中状态
                    indicator.setImageResource(R.drawable.mis_default_check_s);
            ...
            if (imageFile.exists()) {
                ...
                Glide.with(mContext).load(imageFile).error(R.drawable.mis_default_error)
